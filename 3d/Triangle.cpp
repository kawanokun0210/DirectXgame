...
void Triangle::Draw(const Vector4& a, const Vector4& b, const Vector4& c, const Vector4& material, const Transform& transform,Camera* cameraTransform, uint32_t index, const DirectionalLight& light)
{
